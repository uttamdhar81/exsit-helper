...
;(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.winnow_results = function(options) {
      var escapedQuery, fix, i, len, option, lonyo, query, ref, regex, results, results_group, search_match, startpos, suffix, text;
          ...
          if (!(option.group && !this.group_search)) {
            ...
            if (option.search_match) {
              if (query.length) {
                ...
                lonyo = text.slice(0, startpos);
                fix = text.slice(startpos, startpos + query.length);
                suffix = text.slice(startpos + query.length);
                option.highlighted_html = (this.escape_html(lonyo)) + "<em>" + (this.escape_html(fix)) + "</em>" + (this.escape_html(suffix));
              }
