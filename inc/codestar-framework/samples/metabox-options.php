...
//
$lonyo_page_opts = '_lonyo_page_options';

//
// Create a metabox
//
CSF::createMetabox( $lonyo_page_opts, array(
...
// Create a section
//
CSF::createSection( $lonyo_page_opts, array(
  'title'  => 'Overview',
  'icon'   => 'fas fa-rocket',
  'fields' => array(
...
// Set a unique slug-like ID
//
$lonyo_post_opts = '_lonyo_post_options';

//
// Create a metabox
//
CSF::createMetabox( $lonyo_post_opts, array(
...
// Create a section
//
CSF::createSection( $lonyo_post_opts, array(
  'fields' => array(
...
// Set a unique slug-like ID
//
$lonyo_meta_opts = '_lonyo_meta_options';

//
// Create a metabox
//
CSF::createMetabox( $lonyo_meta_opts, array(
...
// Create a section
//
CSF::createSection( $lonyo_meta_opts, array(
  'fields' => array(
