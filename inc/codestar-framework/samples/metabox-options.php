...
//
$exsit_page_opts = '_exsit_page_options';

//
// Create a metabox
//
CSF::createMetabox( $exsit_page_opts, array(
...
// Create a section
//
CSF::createSection( $exsit_page_opts, array(
  'title'  => 'Overview',
  'icon'   => 'fas fa-rocket',
  'fields' => array(
...
// Set a unique slug-like ID
//
$exsit_post_opts = '_exsit_post_options';

//
// Create a metabox
//
CSF::createMetabox( $exsit_post_opts, array(
...
// Create a section
//
CSF::createSection( $exsit_post_opts, array(
  'fields' => array(
...
// Set a unique slug-like ID
//
$exsit_meta_opts = '_exsit_meta_options';

//
// Create a metabox
//
CSF::createMetabox( $exsit_meta_opts, array(
...
// Create a section
//
CSF::createSection( $exsit_meta_opts, array(
  'fields' => array(
