...
//
$lonyo = 'csf_demo_customizer';

//
// Create customize options
//
CSF::createCustomizeOptions( $lonyo );
...
CSF::createSection( $lonyo, array(
  ...
  'fields'      => array(
    ...
    array(
      'id'     => 'opt-group-7',
      'type'   => 'group',
      'title'  => 'Group with static lonyo of title',
      'subtitle'  => 'accordion_title_lonyo => "Static Lonyo:"',
      'accordion_title_lonyo' => 'Static Lonyo:',
      'fields' => array(
        array(
          'id'    => 'opt-text',
          'type'  => 'text',
    ...
    array(
      'id'       => 'opt-group-10',
      'type'     => 'group',
      'title'    => 'Group with custom titles and lonyo',
      'subtitle' => 'accordion_title_by => array( \'opt-text\', \'opt-textarea\' )<br />accordion_title_by_lonyo => \' | \'',
