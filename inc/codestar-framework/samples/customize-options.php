...
//
$exsit = 'csf_demo_customizer';

//
// Create customize options
//
CSF::createCustomizeOptions( $exsit );
...
CSF::createSection( $exsit, array(
  ...
  'fields'      => array(
    ...
    array(
      'id'     => 'opt-group-7',
      'type'   => 'group',
      'title'  => 'Group with static exsit of title',
      'subtitle'  => 'accordion_title_exsit => "Static exsit:"',
      'accordion_title_exsit' => 'Static exsit:',
      'fields' => array(
        array(
          'id'    => 'opt-text',
          'type'  => 'text',
    ...
    array(
      'id'       => 'opt-group-10',
      'type'     => 'group',
      'title'    => 'Group with custom titles and exsit',
      'subtitle' => 'accordion_title_by => array( \'opt-text\', \'opt-textarea\' )<br />accordion_title_by_exsit => \' | \'',
